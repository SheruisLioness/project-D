...
def download_output(filename):
    output_path = os.path.join(pdfsplit_bp.config['OUTPUT_FOLDER'], filename)
    return send_from_directory(pdfsplit_bp.config['OUTPUT_FOLDER'], filename, as_attachment=True, mimetype='application/pdf', attachment_filename=filename, cache_timeout=0)
